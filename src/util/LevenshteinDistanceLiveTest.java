...
public class LevenshteinDistanceLiveTest {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("Type /q at any time to quit, or /n to move on the next step or /b to move backwards.");
            ...
            if(in.equals("/q") || in.equals("/b")) {
                ...
                while(true) {
                    ...
                    if(in.equals("/q")) {
                        ...
                        System.out.println("Result\t: " + LevenshteinDistance.compare(in, strings));
                        System.out.println("================");
                    }
                }
            } else {
