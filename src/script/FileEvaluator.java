...
public class FileEvaluator {
	...
	public void evaluate(Path file) throws ScriptException {
		...
		try {
			...
			Logger.getLogger(this.getClass().getName()).log(Level.INFO, "Reading file: \"" + file + "\".");
		    String line = null;
			...
			Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "Failed to read file: \"" + file + "\". Are you sure is exists?");
			ioe.printStackTrace();
		}
